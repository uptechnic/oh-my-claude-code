...
import { every } from 'src/utils/text/set.js';
...
import { collapseBackgroundBashNotifications } from '../utils/bash/collapseBackgroundBashNotifications.js';
